...
import json
from ...models import Corrections, LanguagesFramework, LibraryLanguages
from ..utils import action_button

class LanguageDisplayMixin:
    """
    Mixin pour les méthodes d'affichage de l'administration des langages.
    Contient les méthodes pour afficher les indicateurs, les liens et les statistiques.
    """
...
class LanguageActionsMixin:
    """
    Mixin pour les actions personnalisées de l'administration des langages.
    Contient les méthodes pour exporter, marquer comme mis en avant, etc.
    """
...
class LanguageFormMixin:
    """
    Mixin pour la personnalisation des formulaires de l'administration des langages.
    Contient les méthodes pour personnaliser l'interface de changement et les formulaires.
    """
